...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>VulnerabilityGPT</title>
        <meta name="description" content="Generated by create-t3-app" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <main>
        <div className="color-slate-50 container flex flex-col items-center justify-center gap-12  border-slate-50 px-4 py-16">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="14.1 2.59721 71.8 94.8"
            className="h-48 w-48 fill-current text-violet-100"
          >
